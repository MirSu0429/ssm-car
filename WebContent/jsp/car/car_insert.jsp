		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td width="637" valign="top" align="center">
					...
					<form action="insertCar.html" method="post" onsubmit="return checkSubmit()">
					<table width="449" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="E4ECEF">
						...
						<tr>
							...
							<td bgcolor="#FFFFFF">
								<input type="text" id="user_number" name="user_number" size="36" />
						...
						<tr>
							<td height="30">地&nbsp;&nbsp;&nbsp;&nbsp;址</td>
							<td bgcolor="#FFFFFF">
								<input type="text" id="address" name="address" size="36" />
						...
						<tr>
							...
							<td bgcolor="#FFFFFF">
								<input type="text" id="car_number"  name="car_number" size="36" />
						...
						<tr>
							<td height="30">电&nbsp;&nbsp;&nbsp;&nbsp;话：</td>
							<td bgcolor="#FFFFFF">
								<input type="text" id="tel" name="tel" size="36" />
						...
						<tr>
							...
							<td bgcolor="#FFFFFF">
								<textarea name="car_road" rows="8" cols="35" id="car_road" ></textarea>
						...
						<tr>
							...
							<td bgcolor="#FFFFFF">
								<textarea name="car_content" rows="8" cols="35" id="car_content" ></textarea>
